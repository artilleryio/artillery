...
class PlatformLambda {
  ...
  async init() {
    console.log(chalk.gray('NOTE: AWS Lambda support is experimental. Not all Artillery features work yet.'));
    console.log(chalk.gray('For details please see https://docs.art/lambda-beta'));
    console.log();
