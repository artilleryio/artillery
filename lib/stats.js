...
Statham.prototype.report = function() {
  ...
  var result = {
    ...
    newScenarios: collection.generatedScenarios.toJSON(),
    completedScenarios: collection.completedScenarios.toJSON(),
    completedRequests: collection.completedRequests.toJSON(),
    rps: {
    ...
    latency: {
      ...
      median: latency.median ? Math.round(latency.median / 1e6 * 100) / 100 : null,
