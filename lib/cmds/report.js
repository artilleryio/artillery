...
class ReportCommand extends Command {
  async run() {
    ...
    // const templateFn = path.join(path.dirname(__filename), '../report/index.html.ejs');
    const templateFn = path.join(path.dirname(__filename), '../report/index2.html.ejs');
...
ReportCommand.description = 'generate a HTML report from a JSON log produced with artillery run';
