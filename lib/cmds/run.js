...
const createRunner = require('../runner-sp');
const createRunnerMulti = require('../runner');
...
class RunCommand extends Command {
  ...
  async run() {
    ...
    try {
      ...
      let runner = createRunner(script, script.config.payload, {
...
RunCommand.description = `run a test script
Run a test script
