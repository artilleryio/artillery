  ...
  if (this.outputFormat === 'new') {
    ...
    [coreRates, engineRates, otherRates].forEach((coll) => {
      coll.forEach((name) => {
        ...
        console.log(util.padded(`${trimName(name)}:`, count) + '/sec');
      });
    });
    ...
    [coreCounters, engineCounters, otherCounters].forEach((coll) => {
      coll.forEach(function(name) {
        ...
        console.log(util.padded(`${trimName(name)}:`, value));
      });
    });
    ...
    [coreSummaries, engineSummaries, otherSummaries].forEach((coll) => {
      coll.forEach((n) => {
        ...
        console.log(util.padded('  min:', r.min));
        console.log(util.padded('  max:', r.max));
        console.log(util.padded('  median:', r.median));
        console.log(util.padded('  p95:', r.p95));
        console.log(util.padded('  p99:', r.p99));
      });
    });
  }
