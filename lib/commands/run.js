  ...
  async.waterfall([
    ...
    function(err, result) {
      ...
      ee.once('done', function(stats) {
        ...
        console.log('min: %s', (latency.min).toFixed(1));
        console.log('max: %s', (latency.max).toFixed(1));
        console.log('p50: %s', (latency.median).toFixed(1));
        console.log('p95: %s', (latency.p95).toFixed(1));
        console.log('p99: %s', (latency.p99).toFixed(1));
